                    ...
                    Select Case BC
                        ...
                        Case 5
                            Select Case CInt(choosen)
                                Case 1 : NS = " מאה " & NS
                                Case 2 : NS = " מאתיים " & NS
                                Case 3 : NS = " שלוש מאות " & NS
                                Case 4 : NS = " ארבע מאות " & NS
                                Case 5 : NS = " חמש מאות " & NS
                                Case 6 : NS = " שש מאות " & NS
                                Case 7 : NS = " שבע מאות " & NS
                                Case 8 : NS = " שמונה מאות " & NS
                                Case 9 : NS = " תשע מאות " & NS
                            End Select
                        Case 6
                            Select Case CInt(choosen)
